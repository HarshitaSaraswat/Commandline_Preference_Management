...
class CommandLineInterface(ArgumentParser):
    def __init__(self, args):
        ...
        self.add_argument(
            "parameter_group_path",
            help="The path of the parameter in the config. eg: `BaseApp/Preference/OpenGL`",
        )
        self.add_argument(
            "-s",
            "--scope",
        ...
        self.add_argument(
            "-n",
            "--name",
            help="The name of the Preference in the given `parameter_group_path`",
        )
        self.add_argument(
            "-v",
            "--value",
            help="The value of the Preference for the given `name`",
        )
        self.add_argument(
            "-d",
            "--dtype",
            choices=[d.name for d in DType], help="The datatype of the Preference you want to access for the given `parameter_group_path`",
        )
        ...
        if self.args.dtype == "Bool" and self.args.value:
